...
description: Compliance Statement and Acceptable Use Policy for the New API Project
---

import { Callout } from 'fumadocs-ui/components/callout';

<Callout type="error">
  Before using New API, please read and understand this policy carefully.
</Callout>
