...
description: Cherry Studio Tutorial — Connecting the desktop AI client to New API, one-click API Key entry. Built-in 30+ professional AI assistants, covering various work scenarios.
---
