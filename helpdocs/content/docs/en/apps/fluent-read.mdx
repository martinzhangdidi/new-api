...
description: FluentRead configuration guide — open-source browser translation plugin with 20+ engines and AI model support. Connect to New API for immersive bilingual reading.
---

<Callout type="info" title="Chat Settings Options">
  In the System Settings -> Chat Settings of the New API console, you can add
...
After the FluentRead plugin is installed in your browser, opening the New API console -> Token Management page will display a prompt to add FluentRead.
