...
description: CC Switch tutorial — a cross-platform tool for unified management of Claude Code, Codex & Gemini CLI provider configs, MCP servers, and system prompts. One-click import from New API.
---
...
1. **On the New API token management page, click the dropdown menu for the corresponding token**
