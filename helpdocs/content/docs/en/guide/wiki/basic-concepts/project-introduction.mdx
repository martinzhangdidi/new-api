...
description: Learn about New API, an AI API gateway and usage management system for legally authorized scenarios.
---
...
New API is an AI API gateway and usage management system designed for legally authorized scenarios, providing unified infrastructure for your AI applications. It is primarily intended for personal use, internal team use, and enterprise private deployment.

<Callout type="info">
  New API seamlessly integrates with leading global AI service providers, including OpenAI, Anthropic, Google
...
New API adopts the **GNU AGPLv3** open-source license. It can be used for free as long as the open-source license is observed.

<Callout type="warn">
  Before using New API, please read the full license terms in the [project
...
<Callout type="warn">
  New API is provided "as is," without warranties of any kind. The developers and maintainers are not liable for any damages or legal issues arising from the use of this software.
</Callout>